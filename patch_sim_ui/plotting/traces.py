"""Main multi-axis trace figure plus visibility-flag bookkeeping.

Holds :class:`TraceVisibility`, :func:`compute_trace_visibility_map`,
:func:`build_figure`, and the private hover-table helper.  Pure functions —
