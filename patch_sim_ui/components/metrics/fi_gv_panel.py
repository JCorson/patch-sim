"""F-I, g-V, τ-V, and I-V curve panels.

Embedded Plotly figures for current-clamp F-I curves and voltage-clamp I-V
analysis (with optional g-V Boltzmann fit and τ-V activation/inactivation
time constants).  The :func:`_iv_curve_tab` composer also reuses the
calcium-transient summary when calcium dynamics were active.
"""
